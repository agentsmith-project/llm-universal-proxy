...
The current published container image is `v0.2.30`, as recorded in
[docs/release-artifacts/container-image.json](release-artifacts/container-image.json):

```text
ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.30
ghcr.io/agentsmith-project/llm-universal-proxy:0.2.30
ghcr.io/agentsmith-project/llm-universal-proxy:latest
ghcr.io/agentsmith-project/llm-universal-proxy@sha256:9fa6cf5318742786c9752452c108498879af2e79968c1505b5a6e52fd7ce4e1f
```

Cargo package version `0.2.33` is the next release identity; it is not a published container tag yet.
Do not bind `v0.2.33` to the digest above until a release workflow has pushed
...
```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.30
```

Pull the immutable digest when you need the exact published artifact:

```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy@sha256:9fa6cf5318742786c9752452c108498879af2e79968c1505b5a6e52fd7ce4e1f
```
...
available in the current published `v0.2.30` image, so a container can start
...
load a static namespace immediately. The current published `v0.2.30` image also
...
Use the `v0.2.30` tag when you want a readable release reference. Use the
`sha256:9fa6cf5318742786c9752452c108498879af2e79968c1505b5a6e52fd7ce4e1f`
