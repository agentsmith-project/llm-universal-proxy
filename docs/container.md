...
The current published container image is `v0.2.28`, as recorded in
[docs/release-artifacts/container-image.json](release-artifacts/container-image.json):

```text
ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.28
ghcr.io/agentsmith-project/llm-universal-proxy:0.2.28
ghcr.io/agentsmith-project/llm-universal-proxy:latest
ghcr.io/agentsmith-project/llm-universal-proxy@sha256:09cc7aa406d8ef82e4bc6bccec3d2b330140f6356044c081d1b9423a5aeac03b
```

Cargo package version `0.2.29` is the next release identity; it is not a published container tag yet.
Do not bind `v0.2.29` to the digest above until a release workflow has pushed
...
```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.28
```

Pull the immutable digest when you need the exact published artifact:

```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy@sha256:09cc7aa406d8ef82e4bc6bccec3d2b330140f6356044c081d1b9423a5aeac03b
```
...
available in the current published `v0.2.28` image, so a container can start
...
load a static namespace immediately. The current published `v0.2.28` image also
...
Use the `v0.2.28` tag when you want a readable release reference. Use the
`sha256:09cc7aa406d8ef82e4bc6bccec3d2b330140f6356044c081d1b9423a5aeac03b`
