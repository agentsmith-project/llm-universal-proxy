...
The current published container image is `v0.2.39`, as recorded in
[docs/release-artifacts/container-image.json](release-artifacts/container-image.json):

```text
ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.39
ghcr.io/agentsmith-project/llm-universal-proxy:0.2.39
ghcr.io/agentsmith-project/llm-universal-proxy:latest
ghcr.io/agentsmith-project/llm-universal-proxy@sha256:c9de8dd036b1f5c3ff1280e61a8041b91e5e3dc6ed806bcfb7d983bde33ffeec
```

Cargo package version `0.2.40` is the next release identity; it is not a published container tag yet.
Do not bind `v0.2.40` to the digest above until a release workflow has pushed
...
```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.39
```

Pull the immutable digest when you need the exact published artifact:

```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy@sha256:c9de8dd036b1f5c3ff1280e61a8041b91e5e3dc6ed806bcfb7d983bde33ffeec
```
...
available in the current published `v0.2.39` image, so a container can start
...
load a static namespace immediately. The current published `v0.2.39` image also
...
Use the `v0.2.39` tag when you want a readable release reference. Use the
`sha256:c9de8dd036b1f5c3ff1280e61a8041b91e5e3dc6ed806bcfb7d983bde33ffeec`
