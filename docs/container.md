...
The current published container image is `v0.2.34`, as recorded in
[docs/release-artifacts/container-image.json](release-artifacts/container-image.json):

```text
ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.34
ghcr.io/agentsmith-project/llm-universal-proxy:0.2.34
ghcr.io/agentsmith-project/llm-universal-proxy:latest
ghcr.io/agentsmith-project/llm-universal-proxy@sha256:b990bec74c113b5a46cdcc11dd6eb94b2702bec92d10431a904480b0bb5745ad
```

Cargo package version `0.2.35` is the next release identity; it is not a published container tag yet.
Do not bind `v0.2.35` to the digest above until a release workflow has pushed
...
```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.34
```

Pull the immutable digest when you need the exact published artifact:

```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy@sha256:b990bec74c113b5a46cdcc11dd6eb94b2702bec92d10431a904480b0bb5745ad
```
...
available in the current published `v0.2.34` image, so a container can start
...
load a static namespace immediately. The current published `v0.2.34` image also
...
Use the `v0.2.34` tag when you want a readable release reference. Use the
`sha256:b990bec74c113b5a46cdcc11dd6eb94b2702bec92d10431a904480b0bb5745ad`
