...
The current published container image is `v0.3.4`, as recorded in
[docs/release-artifacts/container-image.json](release-artifacts/container-image.json):

```text
ghcr.io/agentsmith-project/llm-universal-proxy:v0.3.4
ghcr.io/agentsmith-project/llm-universal-proxy:0.3.4
ghcr.io/agentsmith-project/llm-universal-proxy:latest
ghcr.io/agentsmith-project/llm-universal-proxy@sha256:6a9eb83a423488f6043a35b406ec13c1a1a2251323d43ce4aaa83a9b42f4109f
```

Cargo package version `0.3.5` is the next release identity; it is not a published container tag yet.
Do not bind `v0.3.5` to the digest above until a release workflow has pushed that tag and refreshed
...
```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy:v0.3.4
```

Pull the immutable digest when you need the exact published artifact:

```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy@sha256:6a9eb83a423488f6043a35b406ec13c1a1a2251323d43ce4aaa83a9b42f4109f
```
...
available in the current published `v0.3.4` image, so a container can start
...
load a static namespace immediately. The current published `v0.3.4` image also
...
Use the `v0.3.4` tag when you want a readable release reference. Use the
`sha256:6a9eb83a423488f6043a35b406ec13c1a1a2251323d43ce4aaa83a9b42f4109f`
