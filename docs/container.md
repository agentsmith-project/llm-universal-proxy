...
The current published container image is `v0.2.35`, as recorded in
[docs/release-artifacts/container-image.json](release-artifacts/container-image.json):

```text
ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.35
ghcr.io/agentsmith-project/llm-universal-proxy:0.2.35
ghcr.io/agentsmith-project/llm-universal-proxy:latest
ghcr.io/agentsmith-project/llm-universal-proxy@sha256:0ecec81d77b4fc7c6bcffea0f51efae861eb011260e97b3bdfdba2a99aa60d3a
```

Cargo package version `0.2.36` is the next release identity; it is not a published container tag yet.
Do not bind `v0.2.36` to the digest above until a release workflow has pushed
...
```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.35
```

Pull the immutable digest when you need the exact published artifact:

```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy@sha256:0ecec81d77b4fc7c6bcffea0f51efae861eb011260e97b3bdfdba2a99aa60d3a
```
...
available in the current published `v0.2.35` image, so a container can start
...
load a static namespace immediately. The current published `v0.2.35` image also
...
Use the `v0.2.35` tag when you want a readable release reference. Use the
`sha256:0ecec81d77b4fc7c6bcffea0f51efae861eb011260e97b3bdfdba2a99aa60d3a`
