...
The current published container image is `v0.2.37`, as recorded in
[docs/release-artifacts/container-image.json](release-artifacts/container-image.json):

```text
ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.37
ghcr.io/agentsmith-project/llm-universal-proxy:0.2.37
ghcr.io/agentsmith-project/llm-universal-proxy:latest
ghcr.io/agentsmith-project/llm-universal-proxy@sha256:400c734ce9cbc8b86f8adaec0622be54bc121c67bbb205c0d9782999823dbabb
```

Cargo package version `0.2.38` is the next release identity; it is not a published container tag yet.
Do not bind `v0.2.38` to the digest above until a release workflow has pushed
...
```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.37
```

Pull the immutable digest when you need the exact published artifact:

```bash
docker pull ghcr.io/agentsmith-project/llm-universal-proxy@sha256:400c734ce9cbc8b86f8adaec0622be54bc121c67bbb205c0d9782999823dbabb
```
...
available in the current published `v0.2.37` image, so a container can start
...
load a static namespace immediately. The current published `v0.2.37` image also
...
Use the `v0.2.37` tag when you want a readable release reference. Use the
`sha256:400c734ce9cbc8b86f8adaec0622be54bc121c67bbb205c0d9782999823dbabb`
