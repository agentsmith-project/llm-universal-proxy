...
Status cells in the quick matrix answer whether the capability is officially documented on that provider surface. Portability boundaries and safe-degradation guidance live in the linked detailed docs.
